...
/* Top tab bar = the workbench toolbar */
...
def main():
    ...
    # Top status strip: brand on the left, current state + utility
    # buttons on the right. Replaces what used to live in the sidebar.
    ...
    tabs = st.tabs(
        ["Upload & Forge", "Import Model", "Leaderboard", "Test a Prediction", "Deploy", "Image Classification"]
    )
    with tabs[0]:
        page_upload_train()
    with tabs[1]:
